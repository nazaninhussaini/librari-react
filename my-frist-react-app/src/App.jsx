...
function reducer (state,action){
  ...
  <div className="w-full flex justify-center flex-col items-center gap-4 py-3  ">
    <h1 className="text-center text-3xl bg-linear-60 from-amber-500 to-red-500 text-transparent bg-clip-text">Counter with useReducer</h1>
      ...
      <div className="w-full flex items-center flex-col gap-4 p-2">
        <h1 className="text-center text-3xl bg-linear-60 from-green-600 to-orange-400  text-transparent bg-clip-text">Counter with useRef</h1>
        <button className="text-xl font-normal bg-linear-60 from-green-600 to-orange-400 w-40 text-stone-100 rounded-sm p-2">Increament</button>
        <h1 className="text-center text-xl text-blue-500">0</h1>
        <button className="text-xl font-normal bg-linear-60 from-green-600  to-orange-400 w-40 text-stone-100 rounded-sm p-2">Decreament</button>
      </div>
